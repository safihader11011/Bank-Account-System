...
public class HeadOffice {
    ...
    public String path_current="C:\\Users\\Hp\\Documents\\NetBeansProjects\\controller\\src\\txt_files\\currentaccount.txt";
    public String path_saving="C:\\Users\\Hp\\Documents\\NetBeansProjects\\controller\\src\\txt_files\\savingaccount.txt";
    public String path_monsaving="C:\\Users\\Hp\\Documents\\NetBeansProjects\\controller\\src\\txt_files\\monthlysavingaccount.txt";
    public String path_fixdep="C:\\Users\\Hp\\Documents\\NetBeansProjects\\controller\\src\\txt_files\\fixeddepositaccount.txt";
    public String path_password="C:\\Users\\Hp\\Documents\\NetBeansProjects\\controller\\src\\txt_files\\passward.txt";
    public String path_requests="C:\\Users\\Hp\\Documents\\NetBeansProjects\\controller\\src\\txt_files\\requests.txt";
...
//                    System.out.println("Your Account Number is: " + account_no + " and Branch Code is: " + Information.get(2) + " and you got: " + profit + " after 10 years");
    ...
    public int checkpassward(PasswordField passward) throws FileNotFoundException, IOException {
        ...
        if (passward.getText().equals(result)) {
            return 1;
        } else {
            return 2;
        }
    ...
    public void changePassward(PasswordField newpassword) throws FileNotFoundException, IOException {
        ...
        for (int i = 0; i < newpassword.getText().length(); i++) {
            sb.append((char) (newpassword.getText().charAt(i) ^ key.charAt(i % key.length())));
        }
        String result = sb.toString();
        bw.write(result);
        bw.close();
